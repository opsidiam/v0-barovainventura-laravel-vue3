    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resetModalLabel">Potvrdenie zrušenia licencie</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Ste si istý, že chcete zrušiť licenciu? Táto akcia je nezvratná.
            </div>
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ $url }}" class="d-inline">
                    ...
                    <button type="submit" class="btn btn-danger">Zrušiť licenciu</button>
                </form>
            </div>
        </div>
    </div>
