...
<tr>
    <td>
        <p style="font-size: 8px; text-align: center; line-height: 10px">
            ...
            <br><br>
            Všetky práva vyhradené. Táto správa je určená výlučne adresátovi {{Auth::user()->name ?? $data['user']['name']}} {{Auth::user()->surname ?? $data['user']['surname']}} na e-mail '{{Auth::user()->email_info ?? $data['user']['email_info']}}.
