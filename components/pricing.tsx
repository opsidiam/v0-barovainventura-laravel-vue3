      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4">
            Cenník <span className="text-blue-600">cloud služby</span>
          </h2>
        </div>
          ...
          {plans[period].map((plan, index) => (
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className={plan.highlighted ? "text-blue-100" : "text-gray-600"}>{plan.subtitle}</p>
              </div>
              ...
              <ul className="space-y-3 mb-8">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    <Check
                      className={`w-5 h-5 flex-shrink-0 mt-0.5 ${plan.highlighted ? "text-blue-200" : "text-green-600"}`}
                    />
